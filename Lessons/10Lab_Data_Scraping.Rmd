...
gage_data <- read.table(
  theURL,
  skip = 27, #told R to skip all the stuff that's not data
  header=TRUE,
  sep='\t',
  stringsAsFactors = T) 
...
the_states <- the_website %>% html_nodes(".basic-table a") %>% html_text()
