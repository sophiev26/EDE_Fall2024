...
> Answer: 
Row numbers aren't standard so if data gets rearranged the row numbers might rest/refer to different rows
...
NTL.phys.data.Tuesday.July.19990 <-
  NTL.phys.data %>% 
...
NTL.phys.data.Tuesday.July.19990Depth <-
  NTL.phys.data.Tuesday.July.19990 %>% 
  filter(depth %in% c(0.0:0.26)) %>% 
