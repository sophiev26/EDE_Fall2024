...
ggplot(data=data.frame(x=0,y=0))+
  ...
  geom_text(
    ...
    ) #expression function is like clicking on the equation button in word. everything from now on will be in the expression form
...
Plot_LakeObs_perMonth <-
  ggplot(PeterPaul.chem.nutrients) +
  geom_bar(aes(x=month))
print(Plot_LakeObs_perMonth)
